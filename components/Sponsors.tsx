...
import { Shirt, ShoppingBag, ExternalLink, TicketPercent, Pill, Zap } from 'lucide-react';
...
export const Sponsors: React.FC<LanguageProps> = ({ lang }) => {
  const content = {
    en: {
      ...
      sportsSupps: "Sports Supplements",
      discount: {
  ...
  return (
    <section className="bg-zinc-950 py-24 px-6 border-t border-zinc-900">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Links Grid - Adjusted to 4 columns for desktop */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          ...
          >
            ...
            <h4 className="text-xl font-black text-white uppercase mb-1 font-display">{t.supplements}</h4>
            <div className="flex items-center gap-2 text-yellow-500 font-bold text-lg font-display">
              <span>@phargoods_tw</span>
              <ExternalLink size={16} />
            </div>
          </a>
          ...
          >
            ...
            <h4 className="text-xl font-black text-white uppercase mb-1 font-display">{t.sportsSupps}</h4>
            <div className="flex items-center gap-2 text-yellow-500 font-bold text-lg font-display">
              <span>@riseme.tw</span>
              <ExternalLink size={16} />
            </div>
